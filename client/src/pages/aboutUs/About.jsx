...
const About = () => {
  return (
   <>
   <CommonPage title="Mero Dokan"
            subtitle="About"
            desc=" Welcome to MeroPasal, your one-stop shop for the best shopping experience on the web. We are a small but passionate team of 69 people who are committed to providing our customers with the best possible shopping experience.
            We started MeroPasal in 2023 because we believe that everyone should have access to high-quality products at a fair price. We source our products from all over the world, and we only work with suppliers who share our commitment to quality.
    ...
    "
            ...
            We believe that customer service is our top priority. If you have any questions or concerns, please do not hesitate to contact us. We are here to help you make the most of your MeroPasal experience.
            Thank you for shopping with MeroPasal!"
            btnAbout="Learn more"
            imgAbout={AboutImg}
            visit="/more-info"
