        ...
        <div className="grid gap-8 lg:grid-cols-2">
          <div>
            <h2 className="mb-4 text-3xl font-bold leading-none sm:text-4xl">
              {prop.subtitle} <span className="text-blue-500">{prop.title}</span>
            </h2>
            ...
            <Link
              to={prop.visit}
              className="inline-block py-2 px-4 text-white bg-blue-500 hover:bg-pink-600 rounded-lg text-decoration-none"
